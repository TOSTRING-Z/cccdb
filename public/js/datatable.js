function table(id,data,pageRow){
    ...
    function pageFresh() {
        ...
        $("a").click(function(doc){
            ...
            if (doc.target.className == "list-group-item active"||doc.target.className == "list-group-item"||$(doc.target).parents("a").hasClass("list-group-item")||$(doc.target).parents("a").hasClass("list-group-item active")) {
