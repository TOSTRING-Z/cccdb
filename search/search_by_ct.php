...
$Communication_Type = $_GET['Communication_Type'];
function rm_null($item){
    return (!empty($item));
}
$select_type = array_filter([
    empty($Species)?null:"Species='$Species'",
    empty($Communication_Type)?null:"Communication_Type='$Communication_Type'"
],"rm_null");
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4>Currently,
                ...
                the Communication_Type is <b><font color="red"><?php echo empty($Communication_Type)?"all":$Communication_Type ?></font></b>.
            </h4>
        </div>
        <div class="col-lg-12">
            <div class="box box-color-1">
                ...
                <table id="table">
                    ...
                    while ($rows = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<td>{$rows["Communication_Type"]}</td>";
                    ...
                    echo "<td><a target='_blank' href='search/detail_all.php?id={$rows["id"]}'>more details</a></td>";
