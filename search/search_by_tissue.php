...
$select_type = array_filter([
    ...
    empty($Tissue_Name)?null:"Tissue_Name='$Tissue_Name'",
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4>Currently,
                ...
                the Tissue type is <b><font color="red"><?php echo empty($Tissue_Name)?"all":$Tissue_Name ?></font></b>,
            </h4>
        </div>
        <div class="col-lg-12">
