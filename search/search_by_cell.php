...
<body>
<?php
$Species = $_GET['Species1'];
$Cell_Name1 = $_GET['Cell_Name1'];
$Cell_Name2 = $_GET['Cell_Name2'];
...
$select_type = array_filter([
    ...
    empty($Cell_Name1)?null:"Cell_Name1='$Cell_Name1'",
    empty($Cell_Name2)?null:"Cell_Name2='$Cell_Name2'"
],"rm_null");
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4>Currently,
                ...
                the Cell type 1 is <b><font color="red"><?php echo empty($Cell_Name1)?"all":$Cell_Name1 ?></font></b>,
                the Cell type 2 is <b><font color="red"><?php echo empty($Cell_Name2)?"all":$Cell_Name2 ?></font></b>.
            </h4>
        </div>
        <div class="col-lg-12">
